...
def package(expt_list=["train", "rec", "relax", "cr"], mech_list=["3"], rate="alpha", power=[1], v_range = 1):
    ...
    power = list of powers with which exponents are varied
    v_range = +ve and -ve limit of exponents over which to vary rate
    """
    expt_call_table = {   
                "train"     : re.TrainExpt, 
                "rec"       : re.RecoveryExpt, 
...
if __name__ == "__main__":
    ...
    if pair_expt:
        ...
        package(expt_list, mech_list, rate, power, v_range)
