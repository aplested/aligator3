import numpy as np
from . import MinimumSpanningTree as span
...
class Q_mat:
    ...
    def apply_MR_on_Q(self):
        ...
        for MR_rate in self.mst.MR_paths:
            ...
            print('numerator rates: ', list(zip(num_r, num_rates)))
            print('denominator rates:', list(zip(den_r, den_rates)))
    ...
    def add_agonist_dependence_to_Q(self, drugs):
        ...
        for Row_sum, index in zip(self.Q.sum(1),list(range(self.N_states))):
            self.Q [index, index] = -Row_sum
